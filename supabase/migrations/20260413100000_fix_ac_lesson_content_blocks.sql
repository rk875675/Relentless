-- ============================================================
-- Fix A/C library lesson content_blocks
--
-- The original migrations were pushed with incorrect block types.
-- The migration files were later corrected but db push does not
-- re-apply already-applied migrations. This UPDATE sets the
-- correct content_blocks JSON for all 9 A/C library lessons.
-- ============================================================

begin;

-- A-01: Worry Drop (bubble_sort)
...
-- A-02: Control Check (two_column_sort)
update public.lessons set content_blocks = '{
  "blocks": [
    {
      "type": "tap_through_text",
...
-- A-03: Name It, Face It (prompt_cards)
update public.lessons set content_blocks = '{
  "blocks": [
    {
      "type": "tap_through_text",
...
-- A-04: The Honest Line (prompt_cards)
update public.lessons set content_blocks = '{
  "blocks": [
    {
      "type": "tap_through_text",
...
-- A-05: The Coach''s Perspective (prompt_cards)
update public.lessons set content_blocks = '{
  "blocks": [
    {
      "type": "tap_through_text",
...
-- A-06: Emotional Replay (prompt_cards)
update public.lessons set content_blocks = '{
  "blocks": [
    {
      "type": "tap_through_text",
...
-- C-02: Your Foundation (list_builder)
update public.lessons set content_blocks = '{
  "blocks": [
    {
      "type": "tap_through_text",
...
-- C-03: One Minute Ignition (countdown_timer)
update public.lessons set content_blocks = '{
  "blocks": [
    {
      "type": "tap_through_text",
