-- Fix timed_text cue timings for Days 2-7 based on actual audio durations.
-- Also corrects total_audio_seconds and lesson duration_seconds.
...
set duration_seconds = 305,
  ...
  "blocks": [
    ...
    },
    {
      ...
      "steps": [
        { "text": "Describe a moment where your mind worked against you. Where were you? What was happening? What did your brain start doing instead of competing?", "duration_seconds": 60 },
        { "text": "What was your brain doing? Thinking about the outcome? Watching your competition? Replaying a mistake? Worrying about what others think? Identify the pattern.", "duration_seconds": 45 }
      ]
    },
    {
      "type": "voiceover",
...
-- ============================================================
-- Day 4  (seg01=83s NO AUDIO FILE, seg02=17s)
-- ============================================================
update public.lessons
set duration_seconds = 250,
  ...
  "blocks": [
    ...
    },
    {
      ...
      "ambient_audio": "ambient/ambient_music.mp3",
      "steps": [
        { "text": "I am an athlete who shows up the same — whether I''m winning or losing.", "duration_seconds": 15 },
        { "text": "I am an athlete who competes through discomfort.", "duration_seconds": 15 },
        { "text": "I am an athlete who focuses on the next play, not the last one.", "duration_seconds": 15 },
        { "text": "Now write 2–3 of your own. Present tense. Be specific. Who are you when you step onto the field?", "duration_seconds": 45 }
      ]
    },
    {
      "type": "voiceover",
...
set duration_seconds = 260,
  ...
  "blocks": [
    ...
    },
    {
      ...
      "ambient_audio": "ambient/ambient_music.mp3",
      "steps": [
        { "text": "What is your focus anchor? One or two words. Choose something that brings you into the present moment.", "duration_seconds": 30 },
        { "text": "Hold your anchor. When your mind drifts — and it will — bring it back. That''s the rep.", "duration_seconds": 59 }
      ]
    },
    {
      "type": "voiceover",
