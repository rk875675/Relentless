    ...
    <SafeAreaView style={styles.container}>
      ...
      <Animated.View style={[styles.inner, { opacity: fade }]}>
        ...
        <View style={styles.mockup}>
          ...
          {/* WOD card highlighted */}
          <View style={styles.mockWodHighlight}>
          ...
          {/* Annotation for journal */}
          <View style={styles.callout}>
            <Ionicons name="create-outline" size={14} color={colors.accentLight} />
            <Text style={styles.calloutText}>After each workout you can journal your thoughts</Text>
          </View>
        ...
        <View style={styles.bottom}>
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              router.push('/(onboarding)/tutorial-library' as any);
            }}
          >
...
const styles = StyleSheet.create({
  ...
  mockRingsRow: { flexDirection: 'row', justifyContent: 'space-around', marginBottom: spacing.md },
  mockRing: {
  ...
  mockWodHighlight: {
    ...
    alignItems: 'center', borderWidth: 2, borderColor: colors.accent, marginBottom: spacing.md,
  },
  mockWodLabel: { fontSize: 10, fontWeight: '700', color: colors.textMuted, letterSpacing: 1.5, marginBottom: 2 },
  mockWodDay: { fontSize: 22, fontWeight: '800', color: colors.white },
  annotation: {
